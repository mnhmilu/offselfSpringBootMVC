package com.bkash.frestivalreg.controller;

import com.bkash.frestivalreg.commands.PdfReportResponse;
import com.bkash.frestivalreg.commands.RegistrationForm;

import com.bkash.frestivalreg.commands.RegistrationSearch;
import com.bkash.frestivalreg.converter.RegistrationDataToRegistrationForm;
import com.bkash.frestivalreg.converter.RegistrationFormToRegistrationData;
import com.bkash.frestivalreg.domain.Registration;
import com.bkash.frestivalreg.service.RegistrationService;
import com.bkash.frestivalreg.utility.FileUtility;
import com.bkash.frestivalreg.utility.PdfReportGenerator;
...
public class WebAppContoller {
    ...
    public String searchRegistration(@Valid @ModelAttribute("registrationSearch") RegistrationSearch searchForm, BindingResult bindingResult, Model model, HttpSession session) throws IOException {
        ...
        else
        {
            ...
            model.addAttribute("successMessage", "Search data found!");
        }
    ...
    public String saveRegistration(@ModelAttribute("registration") RegistrationForm form, BindingResult bindingResult, Model model, HttpSession session) throws IOException {
        ...
        Registration registration = registrationService.getRegistrationByAccountNumber(form.getAccountNumber());
        registration.setSourceOfFund(form.getSourceOfFund());
        registration.setEstimatedMonthlyIncome(form.getEstimatedMonthlyIncome());
        registration.setDetailsOfOccupation(form.getDetailsOfOccupation());
        registration.setAutditUser(getUserName());
        registration.setAuditDate(new Date());
